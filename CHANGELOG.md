...
## [1.4.1]
- SDK update to 5.4
- Various bug fixes (including UDP transport fix)
- Update account creation to use new Flexip Account Manager 2.x API with one time password requested inside the app
